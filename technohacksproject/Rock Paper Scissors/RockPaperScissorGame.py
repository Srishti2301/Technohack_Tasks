...
# Define images
Blank_img = PhotoImage(file="Rock Paper Scissors\assets\blank.png")
Player_Rock = PhotoImage(file="Rock Paper Scissors\assets\rock_player.png")
Player_Rock_ado = Player_Rock.subsample(3, 3)
Player_Paper = PhotoImage(file="Rock Paper Scissors/assets/paper_player.png")
Player_Paper_ado = Player_Paper.subsample(3, 3)
Player_Scissor = PhotoImage(file="Rock Paper Scissors/assets/scissor_player.png")
Player_Scissor_ado = Player_Scissor.subsample(3, 3)
Computer_Rock = PhotoImage(file="Rock Paper Scissors/assets/rock_computer.png")
Computer_Paper = PhotoImage(file="Rock Paper Scissors/assets/paper_computer.png")
Computer_Scissor = PhotoImage(file="Rock Paper Scissors/assets/scissor_computer.png")
